...
export default {
  ...
  formatAddress: address => ethers.utils.isAddress(address) ? ethers.utils.getAddress(address) : address,
  abbreviateAddress: address => {
    address = ethers.utils.isAddress(address) ? ethers.utils.getAddress(address) : address
